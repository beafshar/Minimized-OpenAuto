...
class ChannelOpenResponseDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<ChannelOpenResponse>
      _instance;
...
static void InitDefaultsChannelOpenResponse() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_ChannelOpenResponse =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsChannelOpenResponse}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_ChannelOpenResponse.base);
}

::google::protobuf::Metadata file_level_metadata[1];

const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::f1x::aasdk::proto::messages::ChannelOpenResponse, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::f1x::aasdk::proto::messages::ChannelOpenResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::f1x::aasdk::proto::messages::ChannelOpenResponse, status_),
  0,
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::f1x::aasdk::proto::messages::_ChannelOpenResponse_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "ChannelOpenResponseMessage.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "ChannelOpenResponseMessage.proto", &protobuf_RegisterTypes);
...
const int ChannelOpenResponse::kStatusFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

ChannelOpenResponse::ChannelOpenResponse()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_ChannelOpenResponseMessage_2eproto::scc_info_ChannelOpenResponse.base);
  SharedCtor();
  // @@protoc_insertion_point(constructor:f1x.aasdk.proto.messages.ChannelOpenResponse)
}
...
const ::google::protobuf::Descriptor* ChannelOpenResponse::descriptor() {
  ::protobuf_ChannelOpenResponseMessage_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_ChannelOpenResponseMessage_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const ChannelOpenResponse& ChannelOpenResponse::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_ChannelOpenResponseMessage_2eproto::scc_info_ChannelOpenResponse.base);
...
bool ChannelOpenResponse::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:f1x.aasdk.proto.messages.ChannelOpenResponse)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:f1x.aasdk.proto.messages.ChannelOpenResponse)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:f1x.aasdk.proto.messages.ChannelOpenResponse)
  return false;
#undef DO_
}

void ChannelOpenResponse::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:f1x.aasdk.proto.messages.ChannelOpenResponse)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:f1x.aasdk.proto.messages.ChannelOpenResponse)
}

::google::protobuf::uint8* ChannelOpenResponse::InternalSerializeWithCachedSizesToArray(
...
void ChannelOpenResponse::MergeFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:f1x.aasdk.proto.messages.ChannelOpenResponse)
  ...
  const ChannelOpenResponse* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const ChannelOpenResponse>(
          &from);
  if (source == NULL) {
...
void ChannelOpenResponse::CopyFrom(const ::google::protobuf::Message& from) {
...
void ChannelOpenResponse::Swap(ChannelOpenResponse* other) {
...
::google::protobuf::Metadata ChannelOpenResponse::GetMetadata() const {
  protobuf_ChannelOpenResponseMessage_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_ChannelOpenResponseMessage_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::f1x::aasdk::proto::messages::ChannelOpenResponse* Arena::CreateMaybeMessage< ::f1x::aasdk::proto::messages::ChannelOpenResponse >(Arena* arena) {
  return Arena::CreateInternal< ::f1x::aasdk::proto::messages::ChannelOpenResponse >(arena);
}
}  // namespace protobuf
}  // namespace google
