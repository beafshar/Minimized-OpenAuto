...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::f1x::aasdk::proto::messages::PingRequest, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::f1x::aasdk::proto::messages::PingRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::f1x::aasdk::proto::messages::PingRequest, timestamp_),
  0,
};
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 6, sizeof(::f1x::aasdk::proto::messages::PingRequest)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::f1x::aasdk::proto::messages::_PingRequest_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "PingRequestMessage.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "PingRequestMessage.proto", &protobuf_RegisterTypes);
}
...
PingRequest::PingRequest()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_PingRequestMessage_2eproto::scc_info_PingRequest.base);
  SharedCtor();
  // @@protoc_insertion_point(constructor:f1x.aasdk.proto.messages.PingRequest)
}
...
const ::google::protobuf::Descriptor* PingRequest::descriptor() {
  ::protobuf_PingRequestMessage_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_PingRequestMessage_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const PingRequest& PingRequest::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_PingRequestMessage_2eproto::scc_info_PingRequest.base);
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:f1x.aasdk.proto.messages.PingRequest)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:f1x.aasdk.proto.messages.PingRequest)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:f1x.aasdk.proto.messages.PingRequest)
  return false;
#undef DO_
}
...
void PingRequest::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:f1x.aasdk.proto.messages.PingRequest)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:f1x.aasdk.proto.messages.PingRequest)
}
...
::google::protobuf::Metadata PingRequest::GetMetadata() const {
  protobuf_PingRequestMessage_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_PingRequestMessage_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::f1x::aasdk::proto::messages::PingRequest* Arena::CreateMaybeMessage< ::f1x::aasdk::proto::messages::PingRequest >(Arena* arena) {
  return Arena::CreateInternal< ::f1x::aasdk::proto::messages::PingRequest >(arena);
}
}  // namespace protobuf
}  // namespace google
