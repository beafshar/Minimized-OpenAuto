...
#ifndef PROTOBUF_INCLUDED_GearData_2eproto
#define PROTOBUF_INCLUDED_GearData_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_GearData_2eproto 
...
class Gear : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.data.Gear) */ {
 public:
  Gear();
  virtual ~Gear();
 ...
 private:
  ...
  int gear_;
  friend struct ::protobuf_GearData_2eproto::TableStruct;
};
// ===================================================================
...
inline void Gear::set_has_gear() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Gear::clear_has_gear() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void Gear::set_gear(::f1x::aasdk::proto::enums::Gear_Enum value) {
  assert(::f1x::aasdk::proto::enums::Gear_Enum_IsValid(value));
  set_has_gear();
  gear_ = value;
...
#endif  // PROTOBUF_INCLUDED_GearData_2eproto
