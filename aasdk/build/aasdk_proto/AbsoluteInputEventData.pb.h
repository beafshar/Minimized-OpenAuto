...
#ifndef PROTOBUF_INCLUDED_AbsoluteInputEventData_2eproto
#define PROTOBUF_INCLUDED_AbsoluteInputEventData_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_AbsoluteInputEventData_2eproto 
...
class AbsoluteInputEvent : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.data.AbsoluteInputEvent) */ {
 public:
  AbsoluteInputEvent();
  ...
  void Swap(AbsoluteInputEvent* other);
  ...
  inline AbsoluteInputEvent* New() const final {
    return CreateMaybeMessage<AbsoluteInputEvent>(NULL);
  }

  AbsoluteInputEvent* New(::google::protobuf::Arena* arena) const final {
 ...
 private:
  ...
  friend struct ::protobuf_AbsoluteInputEventData_2eproto::TableStruct;
};
// ===================================================================
...
inline void AbsoluteInputEvent::set_has_scan_code() {
  _has_bits_[0] |= 0x00000001u;
}
inline void AbsoluteInputEvent::clear_has_scan_code() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline ::google::protobuf::uint32 AbsoluteInputEvent::scan_code() const {
  // @@protoc_insertion_point(field_get:f1x.aasdk.proto.data.AbsoluteInputEvent.scan_code)
  return scan_code_;
}
inline void AbsoluteInputEvent::set_scan_code(::google::protobuf::uint32 value) {
  set_has_scan_code();
  scan_code_ = value;
...
inline void AbsoluteInputEvent::set_has_value() {
  _has_bits_[0] |= 0x00000002u;
}
inline void AbsoluteInputEvent::clear_has_value() {
  _has_bits_[0] &= ~0x00000002u;
}
...
inline ::google::protobuf::int32 AbsoluteInputEvent::value() const {
  // @@protoc_insertion_point(field_get:f1x.aasdk.proto.data.AbsoluteInputEvent.value)
  return value_;
}
inline void AbsoluteInputEvent::set_value(::google::protobuf::int32 value) {
  set_has_value();
  value_ = value;
...
#endif  // PROTOBUF_INCLUDED_AbsoluteInputEventData_2eproto
