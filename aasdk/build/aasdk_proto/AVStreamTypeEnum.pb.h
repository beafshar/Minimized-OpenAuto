...
#ifndef PROTOBUF_INCLUDED_AVStreamTypeEnum_2eproto
#define PROTOBUF_INCLUDED_AVStreamTypeEnum_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_AVStreamTypeEnum_2eproto 
...
enum AVStreamType_Enum {
  AVStreamType_Enum_NONE = 0,
  AVStreamType_Enum_AUDIO = 1,
  AVStreamType_Enum_VIDEO = 3
};
bool AVStreamType_Enum_IsValid(int value);
const AVStreamType_Enum AVStreamType_Enum_Enum_MIN = AVStreamType_Enum_NONE;
const AVStreamType_Enum AVStreamType_Enum_Enum_MAX = AVStreamType_Enum_VIDEO;
const int AVStreamType_Enum_Enum_ARRAYSIZE = AVStreamType_Enum_Enum_MAX + 1;
...
inline const ::std::string& AVStreamType_Enum_Name(AVStreamType_Enum value) {
  return ::google::protobuf::internal::NameOfEnum(
    AVStreamType_Enum_descriptor(), value);
}
inline bool AVStreamType_Enum_Parse(
    const ::std::string& name, AVStreamType_Enum* value) {
  return ::google::protobuf::internal::ParseNamedEnum<AVStreamType_Enum>(
    AVStreamType_Enum_descriptor(), name, value);
}
// ===================================================================

class AVStreamType : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:f1x.aasdk.proto.enums.AVStreamType) */ {
 public:
  AVStreamType();
  ...
  inline AVStreamType* New() const final {
    return CreateMaybeMessage<AVStreamType>(NULL);
  }

  AVStreamType* New(::google::protobuf::Arena* arena) const final {
  ...
  static const Enum AUDIO =
    AVStreamType_Enum_AUDIO;
  static const Enum VIDEO =
 ...
 private:
  ...
  friend struct ::protobuf_AVStreamTypeEnum_2eproto::TableStruct;
};
// ===================================================================
...
#endif  // PROTOBUF_INCLUDED_AVStreamTypeEnum_2eproto
