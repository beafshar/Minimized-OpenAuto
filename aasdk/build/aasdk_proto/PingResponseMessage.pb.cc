...
namespace protobuf_PingResponseMessage_2eproto {
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::f1x::aasdk::proto::messages::PingResponse, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::f1x::aasdk::proto::messages::PingResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::f1x::aasdk::proto::messages::PingResponse, timestamp_),
  0,
};
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 6, sizeof(::f1x::aasdk::proto::messages::PingResponse)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::f1x::aasdk::proto::messages::_PingResponse_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "PingResponseMessage.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "PingResponseMessage.proto", &protobuf_RegisterTypes);
}
...
PingResponse::PingResponse()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_PingResponseMessage_2eproto::scc_info_PingResponse.base);
  SharedCtor();
  // @@protoc_insertion_point(constructor:f1x.aasdk.proto.messages.PingResponse)
}
...
const ::google::protobuf::Descriptor* PingResponse::descriptor() {
  ::protobuf_PingResponseMessage_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_PingResponseMessage_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const PingResponse& PingResponse::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_PingResponseMessage_2eproto::scc_info_PingResponse.base);
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:f1x.aasdk.proto.messages.PingResponse)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:f1x.aasdk.proto.messages.PingResponse)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:f1x.aasdk.proto.messages.PingResponse)
  return false;
#undef DO_
}
...
void PingResponse::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:f1x.aasdk.proto.messages.PingResponse)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:f1x.aasdk.proto.messages.PingResponse)
}
...
::google::protobuf::Metadata PingResponse::GetMetadata() const {
  protobuf_PingResponseMessage_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_PingResponseMessage_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::f1x::aasdk::proto::messages::PingResponse* Arena::CreateMaybeMessage< ::f1x::aasdk::proto::messages::PingResponse >(Arena* arena) {
  return Arena::CreateInternal< ::f1x::aasdk::proto::messages::PingResponse >(arena);
}
}  // namespace protobuf
}  // namespace google
